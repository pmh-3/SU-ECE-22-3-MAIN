...
from ConcreteClass.HessAffKeypoints import HAKeypoints
import csv
import pyhesaff
...
class HessAffKeypointsGenerator(KeypointsGenerator):
    ...
    def generate_and_save_keypoints_if_not_exist(self, imageObj):
        ...
        kps_path = HAKeypoints.generate_keypoints_path(self.config, imageObj.filename)
    ...
    def generate_and_save_keypoints(self, imageObj, kps_path=None):
        ...
        HAKeypoints.save_keypoints_to_file(kps_path, keypoints, descriptors)
        return kps_path
    ...
    def compute_kps_and_desc(self, imageObj, maskObj=None):
        ...
        (keypoints, descriptors) = pyhesaff.detect_feats(imageObj.filename, **kwargs)
